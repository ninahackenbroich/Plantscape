class User < ApplicationRecord
  ...
  #adding VALIDATION
  # validates :first_name, presence: true, length: { minimum: 2, too_short: "2 characters is the minimum allowed" }
  # validates :last_name, presence: true, length: { minimum: 2, too_short: "2 characters is the minimum allowed" }
